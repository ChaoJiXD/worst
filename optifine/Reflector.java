...
import net.minecraft.forge.common.property.IUnlistedProperty;

public class Reflector
{
    private static boolean logForge = logEntry("*** Reflector Forge ***");
    public static ReflectorClass Attributes = new ReflectorClass("net.minecraft.forge.client.model.Attributes");
    ...
    public static ReflectorClass BlamingTransformer = new ReflectorClass("net.minecraft.forge.fml.common.asm.transformers.BlamingTransformer");
    public static ReflectorMethod BlamingTransformer_onCrash = new ReflectorMethod(BlamingTransformer, "onCrash");
    public static ReflectorClass ChunkWatchEvent_UnWatch = new ReflectorClass("net.minecraft.forge.event.world.ChunkWatchEvent$UnWatch");
    ...
    public static ReflectorClass CoreModManager = new ReflectorClass("net.minecraft.forge.fml.relauncher.CoreModManager");
    public static ReflectorMethod CoreModManager_onCrash = new ReflectorMethod(CoreModManager, "onCrash");
    public static ReflectorClass DimensionManager = new ReflectorClass("net.minecraft.forge.common.DimensionManager");
    ...
    public static ReflectorClass DrawScreenEvent_Pre = new ReflectorClass("net.minecraft.forge.client.event.GuiScreenEvent$DrawScreenEvent$Pre");
    ...
    public static ReflectorClass DrawScreenEvent_Post = new ReflectorClass("net.minecraft.forge.client.event.GuiScreenEvent$DrawScreenEvent$Post");
    ...
    public static ReflectorClass EntityViewRenderEvent_CameraSetup = new ReflectorClass("net.minecraft.forge.client.event.EntityViewRenderEvent$CameraSetup");
    ...
    public static ReflectorClass EntityViewRenderEvent_FogColors = new ReflectorClass("net.minecraft.forge.client.event.EntityViewRenderEvent$FogColors");
    ...
    public static ReflectorClass Event = new ReflectorClass("net.minecraft.forge.fml.common.eventhandler.Event");
    public static ReflectorMethod Event_isCanceled = new ReflectorMethod(Event, "isCanceled");
    public static ReflectorClass EventBus = new ReflectorClass("net.minecraft.forge.fml.common.eventhandler.EventBus");
    public static ReflectorMethod EventBus_post = new ReflectorMethod(EventBus, "post");
    public static ReflectorClass Event_Result = new ReflectorClass("net.minecraft.forge.fml.common.eventhandler.Event$Result");
    ...
    public static ReflectorClass ExtendedBlockState = new ReflectorClass("net.minecraft.forge.common.property.ExtendedBlockState");
    ...
    public static ReflectorClass FMLClientHandler = new ReflectorClass("net.minecraft.forge.fml.client.FMLClientHandler");
    ...
    public static ReflectorClass FMLCommonHandler = new ReflectorClass("net.minecraft.forge.fml.common.FMLCommonHandler");
    ...
    public static ReflectorClass ForgeEventFactory = new ReflectorClass("net.minecraft.forge.event.ForgeEventFactory");
    ...
    public static ReflectorClass ForgeModContainer = new ReflectorClass("net.minecraft.forge.common.ForgeModContainer");
    ...
    public static ReflectorClass GuiModList = new ReflectorClass("net.minecraft.forge.fml.client.GuiModList");
    public static ReflectorConstructor GuiModList_Constructor = new ReflectorConstructor(GuiModList, new Class[] {GuiScreen.class});
    public static ReflectorClass IColoredBakedQuad = new ReflectorClass("net.minecraft.forge.client.model.IColoredBakedQuad");
    public static ReflectorClass IExtendedBlockState = new ReflectorClass("net.minecraft.forge.common.property.IExtendedBlockState");
    public static ReflectorMethod IExtendedBlockState_getClean = new ReflectorMethod(IExtendedBlockState, "getClean");
    public static ReflectorClass IRenderHandler = new ReflectorClass("net.minecraft.forge.client.IRenderHandler");
    public static ReflectorMethod IRenderHandler_render = new ReflectorMethod(IRenderHandler, "render");
    public static ReflectorClass ISmartBlockModel = new ReflectorClass("net.minecraft.forge.client.model.ISmartBlockModel");
    ...
    public static ReflectorClass MinecraftForgeClient = new ReflectorClass("net.minecraft.forge.client.MinecraftForgeClient");
    ...
    public static ReflectorClass ModelLoader = new ReflectorClass("net.minecraft.forge.client.model.ModelLoader");
    public static ReflectorMethod ModelLoader_onRegisterItems = new ReflectorMethod(ModelLoader, "onRegisterItems");
    public static ReflectorClass RenderBlockOverlayEvent_OverlayType = new ReflectorClass("net.minecraft.forge.client.event.RenderBlockOverlayEvent$OverlayType");
    ...
    public static ReflectorClass RenderingRegistry = new ReflectorClass("net.minecraft.forge.fml.client.registry.RenderingRegistry");
    ...
    public static ReflectorClass RenderLivingEvent_Pre = new ReflectorClass("net.minecraft.forge.client.event.RenderLivingEvent$Pre");
    ...
    public static ReflectorClass RenderLivingEvent_Post = new ReflectorClass("net.minecraft.forge.client.event.RenderLivingEvent$Post");
    ...
    public static ReflectorClass RenderLivingEvent_Specials_Pre = new ReflectorClass("net.minecraft.forge.client.event.RenderLivingEvent$Specials$Pre");
    ...
    public static ReflectorClass RenderLivingEvent_Specials_Post = new ReflectorClass("net.minecraft.forge.client.event.RenderLivingEvent$Specials$Post");
    ...
    public static ReflectorClass SplashScreen = new ReflectorClass("net.minecraft.forge.fml.client.SplashProgress");
    public static ReflectorClass WorldEvent_Load = new ReflectorClass("net.minecraft.forge.event.world.WorldEvent$Load");
