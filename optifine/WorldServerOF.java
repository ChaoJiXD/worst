...
{
    private MinecraftServers mcServer;

    public WorldServerOF(MinecraftServers p_i98_1_, ISaveHandler p_i98_2_, WorldInfo p_i98_3_, int p_i98_4_, Profiler p_i98_5_)
    {
