...
public class WorldServer extends World implements IThreadListener
{
    ...
    private final MinecraftServers mcServer;
    ...
    public WorldServer(MinecraftServers server, ISaveHandler saveHandlerIn, WorldInfo info, int dimensionId, Profiler profilerIn)
    {
    ...
    public MinecraftServers getMinecraftServer()
    {
