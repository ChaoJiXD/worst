...
public abstract class MinecraftServers implements Runnable, ICommandSender, IThreadListener, IPlayerUsage
{
    private static final Logger logger = LogManager.getLogger();
    public static final File USER_CACHE_FILE = new File("usercache.json");

    /** Instance of Minecraft Server. */
    private static MinecraftServers mcServer;
    ...
    public MinecraftServers(Proxy proxy, File workDir)
    {
    ...
    public MinecraftServers(File workDir, Proxy proxy, File profileCacheDir)
    {
        this.serverProxy = proxy;
        mcServer = this;
            ...
            this.getActiveAnvilConverter().convertMapFormat(worldNameIn, new IProgressUpdate()
            {
                ...
                public void setLoadingProgress(int progress)
                {
                    if (System.currentTimeMillis() - this.startTime >= 1000L)
                    {
                        ...
                        MinecraftServers.logger.info("Converting... " + progress + "%");
                    }
                }
    ...
    public CrashReport addServerInfoToCrashReport(CrashReport report)
    {
        report.getCategory().addCrashSectionCallable("Profiler Position", new Callable<String>()
        {
            ...
            {
                return MinecraftServers.this.theProfiler.profilingEnabled ? MinecraftServers.this.theProfiler.getNameOfLastSection() : "N/A (disabled)";
            }
        });
        ...
        if (this.serverConfigManager != null)
        {
            report.getCategory().addCrashSectionCallable("Player Count", new Callable<String>()
            {
                public String call()
                {
                    return MinecraftServers.this.serverConfigManager.getCurrentPlayerCount() + " / " + MinecraftServers.this.serverConfigManager.getMaxPlayers() + "; " + MinecraftServers.this.serverConfigManager.func_181057_v();
                }
            });
        }
     ...
     * Gets mcServer.
     */
    public static MinecraftServers getServer()
    {
        return mcServer;
    }
