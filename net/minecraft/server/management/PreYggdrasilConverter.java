...
public class PreYggdrasilConverter
{
    ...
    private static void lookupNames(MinecraftServers server, Collection<String> names, ProfileLookupCallback callback)
    {
    ...
    public static String getStringUUIDFromName(String p_152719_0_)
    {
        ...
        {
            final MinecraftServers minecraftserver = MinecraftServers.getServer();
