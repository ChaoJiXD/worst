...
public class TileEntitySkull extends TileEntity
{
    ...
    public static GameProfile updateGameprofile(GameProfile input)
    {
        if (input != null && !StringUtils.isNullOrEmpty(input.getName()))
        {
            ...
            else if (MinecraftServers.getServer() == null)
            {
                return input;
            }
            else
            {
                GameProfile gameprofile = MinecraftServers.getServer().getPlayerProfileCache().getGameProfileForUsername(input.getName());
                ...
                else
                {
                    ...
                    if (property == null)
                    {
                        gameprofile = MinecraftServers.getServer().getMinecraftSessionService().fillProfileProperties(gameprofile, true);
                    }
