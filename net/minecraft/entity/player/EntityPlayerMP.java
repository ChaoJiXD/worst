...
public class EntityPlayerMP extends EntityPlayer implements ICrafting
{
    ...
    public final MinecraftServers mcServer;
    ...
    public EntityPlayerMP(MinecraftServers server, WorldServer worldIn, GameProfile profile, ItemInWorldManager interactionManager)
    {
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund)
    {
        ...
        {
            if (MinecraftServers.getServer().getForceGamemode())
            {
                this.theItemInWorldManager.setGameType(MinecraftServers.getServer().getGameType());
            }
            else
            {
    ...
    {
        this.playerLastActiveTime = MinecraftServers.getCurrentTimeMillis();
    }
