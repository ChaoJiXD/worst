...
import xyz.WorstClient.module.modules.world.SafeWalk;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void onEntityUpdate()
    {
        ...
        if (!this.worldObj.isRemote && this.worldObj instanceof WorldServer)
        {
            ...
            MinecraftServers minecraftserver = ((WorldServer)this.worldObj).getMinecraftServer();
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double d4 = y;
            double d5 = z;
            Scaffold s =(Scaffold) Client.instance.getModuleManager().getModuleByClass(Scaffold.class);
            boolean flag = this.onGround && this.isSneaking() && this instanceof EntityPlayer || Client.instance.getModuleManager().getModuleByClass(SafeWalk.class).isEnabled() || s.isEnabled()&&((Boolean) s.tower.getValue()).booleanValue()&&((Boolean) s.towermove.getValue()).booleanValue()&&Client.mc.gameSettings.keyBindJump.pressed&& this instanceof EntityPlayer||s.isEnabled()&&s.getBlockCount()==0&& this instanceof EntityPlayer;
    ...
    public void travelToDimension(int dimensionId)
    {
        if (!this.worldObj.isRemote && !this.isDead)
        {
            ...
            MinecraftServers minecraftserver = MinecraftServers.getServer();
