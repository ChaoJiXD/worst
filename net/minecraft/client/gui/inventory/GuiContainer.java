...
import xyz.WorstClient.utils.Translate;
...
public abstract class GuiContainer extends GuiScreen
{
    ...
    Translate translate;
	private ArrayList particles7789;
    ...
    public void initGui()
    {
        ...
        while (i < 150)
        {
          this.particles7789.add(new Object());
          i++;
        }
        super.initGui();
    	...
    	if (Minecraft.theWorld != null && !this.mc.gameSettings.ofFastRender) {
