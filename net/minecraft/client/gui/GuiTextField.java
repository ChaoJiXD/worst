...
public class GuiTextField extends Gui
{
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            int j1 = l;
            drawRect(3, RenderUtil.height()-15, 2, RenderUtil.height()-3, new Color(255,141,255).getRGB());
        	//drawRect(4, RenderUtil.height()-14, 14, RenderUtil.height() - 2, new Color(0,0,0,120).getRGB());
            if (k > s.length())
            {
                k = s.length();
            }
            ...
            if (s.length() > 0)
            {
                ...
                //drawRect(14, RenderUtil.height()-14, 8+this.fontRendererInstance.getStringWidth(s1), RenderUtil.height() - 2, new Color(0,0,0,120).getRGB());
                j1 = this.fontRendererInstance.drawStringWithShadow(s1, (float)l+2, (float)i1, i);
            }
