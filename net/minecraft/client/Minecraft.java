...
import net.minecraft.client.main.Gui;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private PlayerUsageSnooper usageSnooper = new PlayerUsageSnooper("client", this, MinecraftServers.getCurrentTimeMillis());
    ...
    private void setWindowIcon()
    {
        ...
        if (util$enumos != Util.EnumOS.OSX)
        {
            ...
            try
            {
                inputstream = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("Worst/Logo16.png"));
                inputstream1 = this.mcDefaultResourcePack.getResourceStream(new ResourceLocation("Worst/Logo32.png"));
    ...
    public void launchIntegratedServer(String folderName, String worldName, WorldSettings worldSettingsIn)
    {
        ...
        Client.instance.getDiscordRP().update("Playing Single[layer", "In Game");
    }
    ...
    public CrashReport addGraphicsAndWorldToCrashReport(CrashReport theCrash)
    {
        ...
        theCrash.getCategory().addCrashSectionCallable("Is Modded", new Callable<String>()
        {
            public String call() throws Exception
            {
                String s = ClientBrandRetrievers.getClientModName();
    ...
    public void addServerStatsToSnooper(PlayerUsageSnooper playerSnooper)
    {
        ...
        playerSnooper.addClientStat("run_time", Long.valueOf((MinecraftServers.getCurrentTimeMillis() - playerSnooper.getMinecraftStartTimeMillis()) / 60L * 1000L));
    ...
    public void addServerTypeToSnooper(PlayerUsageSnooper playerSnooper)
    {
        ...
        playerSnooper.addStatToSnooper("client_brand", ClientBrandRetrievers.getClientModName());
