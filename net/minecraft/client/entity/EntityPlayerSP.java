...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
        if (Client.instance.getModuleManager().getModuleByClass(Phase.class).isEnabled()) {
            return false;
        }
        if (this.noClip)
        {
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding() && !Client.instance.getModuleManager().getModuleByClass(NoSlowDown.class).isEnabled())
        {
