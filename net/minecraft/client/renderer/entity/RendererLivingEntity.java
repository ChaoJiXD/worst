...
import xyz.WorstClient.module.modules.render.Chams;
import xyz.WorstClient.module.modules.render.Nametags;
import xyz.WorstClient.module.modules.render.setColor;
import xyz.WorstClient.utils.Helper;
import xyz.WorstClient.utils.render.OutlineUtils;
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
    {
        ...
        if (flag || flag1)
        {
            ...
            if ((chams = (Chams)Client.instance.getModuleManager().getModuleByClass(Chams.class)).isEnabled() && chams.mode.getValue() == Chams.ChamsMode.Textured && entitylivingbaseIn instanceof EntityPlayer) {
                ...
                GL11.glColor3f(setColor.r.getValue().intValue()/255.0f,setColor.g.getValue().intValue()/255.0f,setColor.b.getValue().intValue()/255.0f);
