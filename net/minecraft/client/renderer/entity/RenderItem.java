...
import xyz.WorstClient.module.modules.render.EnchantEffect;
...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    private void renderEffect(IBakedModel model)
    {
        if (!Config.isCustomItems() || CustomItems.isUseGlint())
        {
            ...
            {if(Client.getModuleManager().getModuleByClass(EnchantEffect.class).isEnabled()){
    ...
    private void func_175045_a(IBakedModel p_175045_1_, int p_175045_2_, ItemStack p_175045_3_)
    {
        ...
        for (int var8 = 0; var8 < var7; ++var8)
        {
            ...
            this.func_175032_a(var5, p_175045_1_.getFaceQuads(var9), p_175045_2_, p_175045_3_);
        }
	...
	private Object func_175033_a(WorldRenderer p_175032_1_, BakedQuad var7, int var8) {
		// TODO 自动生成的方法存根
		return null;
	}
}
