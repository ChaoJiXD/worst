...
import xyz.WorstClient.module.modules.render.Animations;
...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        ...
        float var4 = Minecraft.thePlayer.getSwingProgress(partialTicks);
            ...
            else if (entityplayersp.getItemInUseCount() > 0)
            {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()])
                {
                    ...
                    case 4:
                    	...
                    	if(Animations.mode.getValue()==Animations.renderMode.ETB) {
                            this.ETB(f, f1);
                            this.func_178103_d();
                        	}
                    	...
                    	if(Animations.mode.getValue()==Animations.renderMode.Vanlia) {
                    	...
                    	if(Animations.mode.getValue()==Animations.renderMode.Jello){
                    	...
                    	if(Animations.mode.getValue()==Animations.renderMode.Swong ) {
                            ...
                            float  var15 = MathHelper.sin((float)(var4 * var4 * 3.1415927f));
                            GlStateManager.translate(-0.05f, 0.4f, 0.0f);
