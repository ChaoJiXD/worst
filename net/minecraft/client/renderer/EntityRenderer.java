...
import xyz.WorstClient.module.modules.player.NoHurtCam;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
	...
	private void hurtCameraEffect(float partialTicks) {
		  if(this.mc.getRenderViewEntity() instanceof EntityLivingBase && !Client.getModuleManager().getModuleByClass(NoHurtCam.class).isEnabled()) {
