...
public class CommandBanIp extends CommandBase
{
    ...
    {
        return MinecraftServers.getServer().getConfigurationManager().getBannedIPs().isLanServer() && super.canCommandSenderUseCommand(sender);
    }
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException
    {
        if (args.length >= 1 && args[0].length() > 1)
        {
            ...
            {
                EntityPlayerMP entityplayermp = MinecraftServers.getServer().getConfigurationManager().getPlayerByUsername(args[0]);
    ...
    {
        return args.length == 1 ? getListOfStringsMatchingLastWord(args, MinecraftServers.getServer().getAllUsernames()) : null;
    }
    ...
    protected void func_147210_a(ICommandSender p_147210_1_, String p_147210_2_, String p_147210_3_)
    {
        ...
        MinecraftServers.getServer().getConfigurationManager().getBannedIPs().addEntry(ipbanentry);
        List<EntityPlayerMP> list = MinecraftServers.getServer().getConfigurationManager().getPlayersMatchingAddress(p_147210_2_);
