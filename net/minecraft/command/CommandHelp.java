...
public class CommandHelp extends CommandBase
{
    ...
    {
        List<ICommand> list = MinecraftServers.getServer().getCommandManager().getPossibleCommands(p_71534_1_);
    ...
    {
        return MinecraftServers.getServer().getCommandManager().getCommands();
    }
