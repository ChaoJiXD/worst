...
public class CommandExecuteAt extends CommandBase
{
    ...
    public void processCommand(final ICommandSender sender, String[] args) throws CommandException
    {
        ...
        else
        {
            ...
            ICommandManager icommandmanager = MinecraftServers.getServer().getCommandManager();
    ...
    {
        return args.length == 1 ? getListOfStringsMatchingLastWord(args, MinecraftServers.getServer().getAllUsernames()) : (args.length > 1 && args.length <= 4 ? func_175771_a(args, 1, pos) : (args.length > 5 && args.length <= 8 && "detect".equals(args[4]) ? func_175771_a(args, 5, pos) : (args.length == 9 && "detect".equals(args[4]) ? getListOfStringsMatchingLastWord(args, Block.blockRegistry.getKeys()) : null)));
    }
