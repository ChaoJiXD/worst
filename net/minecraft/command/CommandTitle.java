...
public class CommandTitle extends CommandBase
{
    ...
    {
        return args.length == 1 ? getListOfStringsMatchingLastWord(args, MinecraftServers.getServer().getAllUsernames()) : (args.length == 2 ? getListOfStringsMatchingLastWord(args, S45PacketTitle.Type.getNames()) : null);
    }
