...
public class CommandGameRule extends CommandBase
{
    ...
    public static void func_175773_a(GameRules p_175773_0_, String p_175773_1_)
    {
        if ("reducedDebugInfo".equals(p_175773_1_))
        {
            ...
            for (EntityPlayerMP entityplayermp : MinecraftServers.getServer().getConfigurationManager().func_181057_v())
            {
    ...
    {
        return MinecraftServers.getServer().worldServerForDimension(0).getGameRules();
    }
}
