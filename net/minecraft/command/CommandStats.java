...
public class CommandStats extends CommandBase
{
    ...
    {
        return MinecraftServers.getServer().getAllUsernames();
    }

    protected List<String> func_175777_e()
    {
        Collection<ScoreObjective> collection = MinecraftServers.getServer().worldServerForDimension(0).getScoreboard().getScoreObjectives();
