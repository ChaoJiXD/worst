...
public class CommandTime extends CommandBase
{
    ...
    {
        for (int i = 0; i < MinecraftServers.getServer().worldServers.length; ++i)
        {
            MinecraftServers.getServer().worldServers[i].setWorldTime((long)p_71552_2_);
        }
    }
    ...
    protected void addTime(ICommandSender p_71553_1_, int p_71553_2_)
    {
        for (int i = 0; i < MinecraftServers.getServer().worldServers.length; ++i)
        {
            WorldServer worldserver = MinecraftServers.getServer().worldServers[i];
