...
public abstract class CommandBase implements ICommand
{
    ...
    public static EntityPlayerMP getPlayer(ICommandSender sender, String username) throws PlayerNotFoundException
    {
        ...
        if (entityplayermp == null)
        {
            try
            {
                entityplayermp = MinecraftServers.getServer().getConfigurationManager().getPlayerByUUID(UUID.fromString(username));
            }
        ...
        if (entityplayermp == null)
        {
            entityplayermp = MinecraftServers.getServer().getConfigurationManager().getPlayerByUsername(username);
        }
