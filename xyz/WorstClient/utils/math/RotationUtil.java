 ...
 */
package xyz.WorstClient.utils.math;
...
public class RotationUtil {
    ...
    public static float[] getRotation(Entity entity) {
        double xPos = entity.posX - Minecraft.thePlayer.posX;
        double zPos = entity.posZ - Minecraft.thePlayer.posZ;
        double yPos = entity.posY - Minecraft.thePlayer.posY;
