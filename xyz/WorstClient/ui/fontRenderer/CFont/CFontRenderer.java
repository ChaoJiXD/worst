package xyz.WorstClient.ui.fontRenderer.CFont;
...
public class CFontRenderer extends CFont {
    ...
    public float drawString(String text, double x, double y, int color, final boolean shadow) {
    	if(text.contains(Minecraft.getMinecraft().session.getUsername()) && ModuleManager.getModuleByClass(NameProtect.class).isEnabled()) {
